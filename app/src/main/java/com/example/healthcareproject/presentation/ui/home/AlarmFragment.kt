...
import com.example.healthcareproject.presentation.ui.home.EditAlarmDialog
    ...
    private fun setupRecyclerView() {
        adapter = AlarmAdapter(
            onEditClick = { reminder ->
                EditAlarmDialog.Companion.newInstance(reminder).show(parentFragmentManager, "EditAlarmDialog")
            },
