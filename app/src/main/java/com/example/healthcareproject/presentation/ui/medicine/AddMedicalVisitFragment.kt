...
class AddMedicalVisitFragment : Fragment() {
        ...
        medicationAdapter = MedicationAdapter(
            onEdit = { medication ->
                ...
                val dialog = AddMedicationDialogFragment.Companion.newInstance(
                    ...
                    sourceFragment = AddMedicationDialogFragment.Companion.SOURCE_MEDICAL_VISIT_FRAGMENT,
    ...
    private fun setupFragmentResultListener() {
        setFragmentResultListener(AddMedicationDialogFragment.Companion.RESULT_KEY_MEDICAL_VISIT_FRAGMENT) { _, bundle ->
