package com.example.healthcareproject.presentation.viewmodel.setting.information
    ...
    fun saveUserInfoByUid(uid: String) {
        viewModelScope.launch {
            ...
            try {
                ...
                Timber.Forest.d("Saving user: $userId, name: $nameValue, dob: $dateOfBirthValue, gender: $genderValue, bloodType: $bloodTypeValue")
